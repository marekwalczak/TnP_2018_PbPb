...
config.General.requestName = 'SL_incoh_Ups_210605'
config.General.workArea = 'crab_projects_Both_SL'
...
config.Data.inputDataset = '/Ups1SMMIncoh_5p02TeV_STARlight/HINPbPbAutumn18DR-NoPU_103X_upgrade2018_realistic_HI_v11-v2/AODSIM'
