...
VEFFICIENCYSET =cms.VPSet(
   ...
   cms.PSet(
      TrkMu_1bin = cms.PSet(
         EfficiencyCategoryAndState = cms.vstring("TM", "true", "SoftId", "true", "HLT_HIUPC_DoubleMu0_NotMBHF2AND_v1", "true"),
...
process.TagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:tnpJpsi_Data_PbP_191205.root"),
    InputDirectoryName = cms.string("tpTreeTrk"),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("Output/Data/tnp_Ana_DATA_1-3_scenario_%s_test01.root" % (scenario) ), #"mass2834" for mass range systematics 
